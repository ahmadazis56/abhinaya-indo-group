                    ...
                    <div class="lg:col-span-8 space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="category" name="category" value="<?php echo htmlspecialchars($portfolio['category']); ?>" placeholder="e.g., Web Design" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-900 focus:outline-none focus:ring-4 focus:ring-brand-600/15 focus:border-brand-600">
                            </div>
                        </div>
