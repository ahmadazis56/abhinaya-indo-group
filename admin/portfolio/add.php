...
<main class="flex-1 lg:ml-72 bg-slate-50 min-h-screen">
    <div class="p-6 sm:p-8 max-w-4xl mx-auto">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Tambah Portfolio</h1>
                <p class="text-slate-500 mt-1 text-sm">Buat dan publikasikan item portofolio baru.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <form method="POST" enctype="multipart/form-data" class="divide-y divide-slate-100">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="5" class="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-900 focus:outline-none focus:ring-4 focus:ring-brand-600/15 focus:border-brand-600 transition-all font-medium placeholder:text-slate-400 resize-y"></textarea>
                        </div>

                        <div id="linkField" class="hidden">
                            <label for="link" id="linkLabel" class="block text-sm font-semibold text-slate-700 mb-2">Tautan Proyek (Project Link)</label>
                            <input type="url" id="link" name="link" placeholder="https://example.com" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-900 focus:outline-none focus:ring-4 focus:ring-brand-600/15 focus:border-brand-600 transition-all font-medium placeholder:text-slate-400">
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="tags" class="block text-sm font-semibold text-slate-700 mb-2">Tags / Label</label>
                                <input type="text" id="tags" name="tags" placeholder="e.g., design, ui/ux" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-900 focus:outline-none focus:ring-4 focus:ring-brand-600/15 focus:border-brand-600 transition-all font-medium placeholder:text-slate-400">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label for="image" class="block text-sm font-semibold text-slate-700 mb-2">Pilih File Gambar *</label>
                            ...
                            <div class="relative group cursor-pointer border-2 border-dashed border-slate-300 rounded-2xl hover:border-brand-500 hover:bg-brand-50 transition-all duration-300 w-full text-center overflow-hidden">
                                <input type="file" id="image" name="image" accept="image/*" required onchange="previewPortfolioImage(event)" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10">
                                ...
                                <div class="px-6 py-12 flex flex-col items-center justify-center pointer-events-none">
                                    ...
                                    <h4 class="text-slate-800 font-bold mb-1 text-lg">Klik atau seret gambar ke sini</h4>
                                    <p class="text-slate-500 mb-4 text-sm">Preview gambar akan otomatis muncul.</p>
