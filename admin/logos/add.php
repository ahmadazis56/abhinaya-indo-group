    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <div class="flex items-start justify-between gap-4 mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900">Add Logo</h1>
                    <p class="text-slate-600 mt-1">Add a new client or partner logo</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div class="lg:col-span-8 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" placeholder="Brief description of the client or partner" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-900 focus:outline-none focus:ring-4 focus:ring-brand-600/15 focus:border-brand-600"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-4 space-y-5">
                        <div>
                            ...
                            <div class="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-4 text-center">
                                ...
                                <input type="file" id="image" name="image" accept="image/*" required class="block w-full text-sm text-slate-700 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:bg-brand-600 file:text-white file:font-semibold hover:file:bg-brand-700" onchange="previewLogo(event)">
                                <div class="mt-2 text-[10px] text-slate-500 uppercase tracking-wider font-bold">Allowed: JPG, PNG, GIF, WebP (Max 5MB)</div>
                            </div>
                        </div>
