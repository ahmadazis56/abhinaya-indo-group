...
<head>
    ...
    <title>Gallery - Abhinaya Indo Group</title>
    <meta name="description" content="Photo gallery of Abhinaya Indo Group events, projects, and team activities.">
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Photo Gallery</h2>
...
<section class="py-20 bg-gradient-to-br from-[#0e6d7c] to-[#14aecf]">
    <div class="container mx-auto px-6 text-center">
        <div class="max-w-3xl mx-auto" data-aos="fade-up">
            <h2 class="text-4xl md:text-5xl font-bold mb-6 text-white">Want to See More?</h2>
