  ...
  <div class="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
      ...
      <div class="bg-white rounded-[2rem] p-10 border border-gray-100 shadow-hostinger hover:-translate-y-2 hover:shadow-hostinger-hover transition-all duration-300 relative flex flex-col" data-aos="fade-up" data-aos-delay="100">
        ...
        <a href="https://wa.me/6285646603602?text=Halo%20Tim%20Abhinaya%2C%20saya%20ingin%20berkonsultasi%20mengenai%20layanan%20Techno%3A%20paket%20Basic%20Digital.%20Boleh%20minta%20informasi%20lebih%20lanjut%3F" target="_blank" class="w-full block text-center py-4 bg-white text-slate-900 font-bold border-2 border-slate-200 rounded-2xl hover:border-primary-500 hover:text-primary-600 transition-colors">Get Started</a>
      </div>
      ...
      <div class="bg-primary-50 rounded-[2rem] p-10 border-2 border-primary-500 shadow-hostinger hover:-translate-y-2 hover:shadow-hostinger-hover transition-all duration-300 relative flex flex-col md:-translate-y-4" data-aos="fade-up" data-aos-delay="200">
        ...
        <a href="https://wa.me/6285646603602?text=Halo%20Tim%20Abhinaya%2C%20saya%20ingin%20berkonsultasi%20mengenai%20layanan%20Techno%3A%20paket%20Professional%20Digital.%20Boleh%20minta%20informasi%20lebih%20lanjut%3F" target="_blank" class="w-full block text-center py-4 bg-primary-500 text-white font-bold rounded-2xl hover:bg-primary-600 shadow-md hover:shadow-lg transition-all">Get Started</a>
      </div>
      <!-- Enterprise Solution -->
      <div class="bg-white rounded-[2rem] p-10 border border-gray-100 shadow-hostinger hover:-translate-y-2 hover:shadow-hostinger-hover transition-all duration-300 relative flex flex-col" data-aos="fade-up" data-aos-delay="300">
        ...
        <a href="https://wa.me/6285646603602?text=Halo%20Tim%20Abhinaya%2C%20saya%20ingin%20berkonsultasi%20mengenai%20layanan%20Techno%3A%20paket%20Enterprise%20Solution.%20Boleh%20minta%20informasi%20lebih%20lanjut%3F" target="_blank" class="w-full block text-center py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 transition-colors">Contact Sales</a>
      </div>
    </div>
  </div>
</section>
